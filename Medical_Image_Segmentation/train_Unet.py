...
from unet import UNet,UNet1,ResNetUNet
from utils import *
import vnet
...
def train_net(net,
              ...
              gpu=True,
              target_path = '',
              checkpoint_path='/mnt/HDD1/Frederic/Seg_unet/checkpoints/',
              result_path ='/mnt/HDD1/Frederic/Seg_unet/result/'):
...
#Use checkpoint
    ...
    if args.test:
        ...
        best_checkpoint = '/home/fred/Documents/Seg_unet/checkpoints/best_checkpoint.pth'
        test_net(net = net,
                dataset = testloader,
