...
result_path_global = '/mnt/HDD1/Frederic/Segmentation/Seg_deepv3/result/'
def train_net(net,
			  epochs=5,
			  batch_size=2,
			  lr=0.0001,
...
if __name__ == '__main__':
	...
	net = torch.hub.load('pytorch/vision:v0.4.0', 'deeplabv3_resnet101', pretrained=True)
...
#Use checkpoint
	...
	if args.test:
		...
		best_checkpoint = '/mnt/HDD1/Frederic/Segmentation/Seg_deepv3/checkpoints/best_checkpoint.pth'
		test_net(net = net,
				dataset = testloader,
